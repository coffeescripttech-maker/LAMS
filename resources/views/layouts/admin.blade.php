...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" id="events" data-name="events" href="{{ url('/admin/events') }}">
                    <i class="ri-calendar-line"></i>
                    <span>Events</span>
                </a>
            </li>
            <li class="nav-heading">Auth Management</li>
            <li class="nav-item">
                <a class="nav-link collapsed" id="faculty" data-name="faculty"
                    href="{{ url('/admin/users/faculty') }}">
                    <i class="ri-user-star-line"></i>
                    <span>Faculties</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" id="student" data-name="student"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" id="sections" data-name="sections"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" id="schedules" data-name="schedules"
                    href="{{ url('/admin/schedules') }}">
                    <i class="ri-calendar-2-line"></i>
                    <span>Schedule of Lab</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" id="reservations" data-name="reservations"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" id="settings" data-name="settings"
        ...
        <div class="d-flex justify-content-center ">
            <img src="{{ asset('img/logo.jpg') }}" alt="logo" class="shadow-lg rounded"
