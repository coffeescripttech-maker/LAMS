...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/faculty/dashboard') }}" id="dashboard"
                    data-name="dashboard">
            ...
            @if (Auth::user()->deleted_at == null)
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" id="student" data-name="student"
                        href="{{ url('/faculty/users/student') }}">
